...
const CreateUniverse = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!name || !description || !selectedBackground) {
      setError("Name, description, and background image are required.");
      return;
    }

    try {
      console.log(name, description, selectedBackground);
      ...
      <div className="UniverseForm">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="background-dropdown">
            <p>Universe background: choose from our gallery or import your own</p>
